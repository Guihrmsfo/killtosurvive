<%-- 
    Document   : skills
    Created on : 29/10/2012, 01:39:17
    Author     : Guilherme
--%>
                                    ...
                                    <center>
                                        <table width="550">
                                            <tr>
                                                <td align="center">
                                                    <p class="title">
                                                        <fmt:message key="skillspage.text.skills"/>
                                                    </p>
                                                    
                                                    <c:if test="${fn:length(sessionScope.usuario.personagem.habilidades)==0}">
                                                        <fmt:message key="skillspage.text.noskill"/>
                                                    </c:if>
                                                    
                                                    <c:forEach items="${sessionScope.usuario.personagem.habilidades}" begin="0"  step="1" var="habilidade">
                                                        <h:skills language="${language}" name="${habilidade.nome}" description="${habilidade.descricao}" value="${habilidade.valor}" effect="${habilidade.efeito}"/>
                                                    </c:forEach>
                                                </td>
                                            </tr>
                                        </table>
